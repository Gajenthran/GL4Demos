...
static const char * _texture_filenames[] = { 
  "images/star00.png", 
  "images/star00_bump.png", 
  "images/star00_glossmap.png",
  "images/star01.png",
  "images/star02.png",
  "images/star03.png",
  "images/star04.png",
...
enum texture_e {
  TE_STAR00 = 0,  /* star00.png */
  TE_EBUMP,       /* star00_bump.png */
  TE_EGLOSS,      /* star00_glossmap.png */
  TE_END          /* nombre de textures */
};
...
static void init(int w, int h) {
  ...
  glClearColor(0.13f, 0.14f, 0.60f, 0.0f);
  _pId  = gl4duCreateProgram("<vs>shaders/full.vs", "<fs>shaders/full.fs", NULL);
